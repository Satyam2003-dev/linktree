    ...
    <SectionBox>
      <form action={save}>
        ...
        <button
          ...
          <FontAwesomeIcon className="bg-green-500 text-white p-1 rounded-full aspect-square" icon={faPlus} />
          <span>Add new</span>
        </button>
        <div className="">
          <ReactSortable
                ...
                <div className="text-center">
                  ...
                  <div>
                    <input
                      ...
                      type="file"
                      className="hidden"/>
                    <label htmlFor={'icon'+l.key} className="border mt-2 p-2 flex items-center rounded gap-1 text-gray-600 cursor-pointer mb-2 justify-center">
                      <FontAwesomeIcon icon={faCloudArrowUp} />
                      <span>Change icon</span>
                    </label>
                    <button
                      onClick={() => removeLink(l.key)}
                      type="button" className="w-full bg-gray-300 py-2 px-3 mb-2 h-full flex gap-2 rounded items-center justify-center">
        ...
        <div className="border-t pt-4 mt-4 rounded">
          <SubmitButton className="max-w-xs mx-auto rounded">
