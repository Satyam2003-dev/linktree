      ...
      <div className="flex gap-2 justify-center mt-4 pb-4">
        {Object.keys(page.buttons).map(buttonKey => (
          <Link key={buttonKey} href={buttonLink(buttonKey, page.buttons[buttonKey])}
                className="rounded-full bg-white text-green-950 p-2 flex items-center justify-center">
        ...
        {page.links.map(link => (
          <Link
            ...
            <div className="relative -left-4 overflow-hidden w-16">
              <div className="w-16 h-16 bg-green-700 aspect-square relative flex items-center justify-center aspect-square">
                {link.icon && (
                  <Image
